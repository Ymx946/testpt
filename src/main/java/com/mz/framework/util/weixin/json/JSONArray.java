...
public class JSONArray {
    ...
    /**
     * Make a string from the contents of this JSONArray. The <code>separator</code> string is inserted between each element. Warning: This method assumes that the data structure
     * is acyclical.
     *
    ...
    /**
     * Get the optional boolean value associated with an index. It returns the defaultValue if there is no value at that index or if it is not a Boolean or the String "true" or
    ...
    /**
     * Get the optional double value associated with an index. NaN is returned if there is no value for the index, or if the value is not a number and cannot be converted to a
     * number.
     *
     * @param index The index must be between 0 and length() - 1.
     * @return The value.
    ...
    /**
     * Get the optional double value associated with an index. The defaultValue is returned if there is no value for the index, or if the value is not a number and cannot be
    ...
    /**
     * Get the optional int value associated with an index. Zero is returned if there is no value for the index, or if the value is not a number and cannot be converted to a
     * number.
     *
     * @param index The index must be between 0 and length() - 1.
     * @return The value.
    ...
    /**
     * Get the optional int value associated with an index. The defaultValue is returned if there is no value for the index, or if the value is not a number and cannot be converted
     * to a number.
     *
     * @param index        The index must be between 0 and length() - 1.
     * @param defaultValue The default value.
    ...
    /**
     * Get the optional long value associated with an index. Zero is returned if there is no value for the index, or if the value is not a number and cannot be converted to a
     * number.
     *
     * @param index The index must be between 0 and length() - 1.
     * @return The value.
    ...
    /**
     * Get the optional string value associated with an index. It returns an empty string if there is no value at that index. If the value is not a string and is not null, then it
    ...
    /**
     * Make a JSON text of this JSONArray. For compactness, no unnecessary whitespace is added. If it is not possible to produce a syntactically correct JSON text then null will be
     * returned instead. This could occur if the array contains an invalid number.
     * <p>
     ...
     * @return a printable, displayable, transmittable representation of the object, beginning with <code>[</code>&nbsp;<small>(left bracket)</small> and ending with <code>]</code>
    ...
    Writer write(Writer writer, int indentFactor, int indent) throws JSONException {
        try {
            ...
            if (length == 1) {
                JSONObject.writeValue(writer, this.myArrayList.stream().findFirst().get(), indentFactor, indent);
            } else if (length != 0) {
