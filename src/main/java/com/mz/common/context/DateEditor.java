...
public class DateEditor extends PropertyEditorSupport {
     ...
     *
     * @param value  值
     * @param toType 目标类型（可选：java.util.Date.class、java.sql.Timestamp.class、java.sql
     *               .Time.class）
     * @return 转换后的值
     * @author sunju @creationDate. 2013-12-7 下午09:43:40
     */
        ...
        try {
            ...
            if (!(Date.class == toType)) {
                try {
                    ...
                    return constructor.newInstance(Long.valueOf(result.getTime()));
                } catch (Exception e) {
     ...
     *
     * @return 时间格式数组
     * @author sunju @creationDate. 2013-12-7 下午08:55:02
     */
    private DateFormat[] getDateFormats() {
        ...
        DateFormat rfc33992 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        DateFormat rfc33993 = new SimpleDateFormat("yyyy-MM-dd");

        return new DateFormat[]{dt1, dt2, dt3, rfc3399, d1, d2, d3, rfc33992, rfc33993};
    }
