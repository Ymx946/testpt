...
public class HanziToNum {
    ...
    private static String stryione = "";
    private static String strwan = "";
    ...
    public static long chnStrToNum(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            // 数字
            if (numMap.containsKey(String.valueOf(bit))) {
                value1 = numMap.get(String.valueOf(bit));
                if (i == str.length() - 1) {
                    strreuslt += value1;
                }
            ...
            // 单位
            else if (unitMap.containsKey(String.valueOf(bit))) {
                value2 = unitMap.get(String.valueOf(bit));
