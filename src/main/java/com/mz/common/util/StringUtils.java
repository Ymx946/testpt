...
import com.mz.common.util.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static boolean ishttp(String link) {
        return StringUtils.startsWithAny(link, ConstantsUtil.HTTP, ConstantsUtil.HTTPS);
    }
    ...
    public static  String dealIdNo(String idNumber) {
        ...
        if (lastChar == 'x') { // 判断最后一位是否为小写x
            idNumber = idNumber.substring(0, idNumber.length() - 1) + 'X'; // 替换为大写X
        }
        return idNumber;
    }
    ...
    public static String generateSerialNumber() {
        ...
        String serialNumberString = String.format("%04d", serialNumber);
        return formattedDate + serialNumberString;
    }
}
