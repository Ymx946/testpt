...
import com.mz.common.util.NumberUtil;
import com.mz.common.util.StringUtils;
import com.mz.common.util.seal.entity.seal.SealCircle;
import com.mz.common.util.seal.entity.seal.SealConfiguration;
import com.mz.common.util.seal.entity.seal.SealFont;
...
public abstract class SealUtil {
    ...
    public final static Double FONT_SIZE_NUMERATOR = 8.0;
    public final static Double FONT_SIZE_FACTOR = 44.0;

    public static void main(String[] args) throws Exception {
        String mainTxt = "华安县沙建中心卫生院";
        String viceTxt = "";
        String titleTxt = "\n\n\n\n\n\n家庭医生签约\n专用章";
        String targetFile = "C:/Users/Administrator/Desktop/" + UUID.randomUUID().toString().replace("-", "") + ".png";

//        Double mul = NumberUtil.mul(NumberUtil.div(FONT_SIZE_NUMERATOR, groupName.length()), FONT_SIZE_FACTOR);
//        System.out.println(mul);
//        System.out.println(mul.intValue());

        ByteArrayOutputStream byteArrayOutputStream = SealUtil.genCircleSeal(mainTxt, viceTxt, "★", titleTxt);
     ...
     *
     * @param mainTxt   - 主文字
     * @param viceTxt   - 副文字（下弦文）
     * @param centerTxt - 中心文字（星号"★"）
     * @param titleTxt  - 抬头文字（横向文）
     */
    public static ByteArrayOutputStream genCircleSeal(String mainTxt, String viceTxt, String centerTxt, String titleTxt) throws Exception {
        SealConfiguration sealConfig = new SealConfiguration();
...
//        mainFont.setFontFamily("楷体");
        ...
        mainFont.setFontText(mainTxt);
        mainFont.setFontSize(40);
//        mainFont.setFontSpace(29.0);
        Double mainFontFontSpaceDouble = NumberUtil.mul(NumberUtil.div(SealUtil.FONT_SIZE_NUMERATOR, mainTxt.length()), SealUtil.FONT_SIZE_FACTOR);
        mainFont.setFontSpace(mainFontFontSpaceDouble);
        // 添加主文字
        sealConfig.setMainFont(mainFont);

        if (StringUtils.isNotBlank(viceTxt)) {
            SealFont viceFont = new SealFont();
            viceFont.setBold(true);
            viceFont.setFontFamily("宋体");
            viceFont.setMarginSize(5);
            viceFont.setFontText(viceTxt);
            viceFont.setFontSize(13);
            viceFont.setFontSpace(12.0);
            // 添加副文字
            sealConfig.setViceFont(viceFont);
        }

        if (StringUtils.isNotBlank(centerTxt)) {
            SealFont centerFont = new SealFont();
            centerFont.setBold(true);
            centerFont.setFontFamily("宋体");
            centerFont.setFontText(centerTxt);
            centerFont.setFontSize(100);
            // 添加中心文字
            sealConfig.setCenterFont(centerFont);
        }

        if (StringUtils.isNotBlank(titleTxt)) {
            SealFont titleFont = new SealFont();
            titleFont.setBold(true);
            titleFont.setFontFamily("宋体");
            titleFont.setFontSize(30);
            titleFont.setFontText(titleTxt);
            titleFont.setMarginSize(66);
//            titleFont.setFontSpace(80.0);
            Double titleFontFontSpaceDouble = NumberUtil.mul(NumberUtil.div(SealUtil.FONT_SIZE_NUMERATOR, mainTxt.length()), SealUtil.FONT_SIZE_FACTOR);
            titleFont.setFontSpace(titleFontFontSpaceDouble);
            // 添加抬头文字
            sealConfig.setTitleFont(titleFont);
        }

        /**
         * 图片大小
         */
        sealConfig.setImageSize(300);
        /**
         * 背景颜色
         */
        sealConfig.setBackgroudColor(Color.RED);
        /**
         * 边线粗细、半径
         */
        sealConfig.setBorderCircle(new SealCircle(4, 140, 140));

        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
        ImageIO.write(buildSeal(sealConfig), "png", outStream);
        return outStream;
    }
     ...
     * @param mainTxt   - 主文字
     * @param viceTxt   - 副文字
     * @param centerTxt - 中心文字
     * @param titleTxt  - 抬头文字
     */
    public static ByteArrayOutputStream genEllipticalSeal(String mainTxt, String viceTxt, String centerTxt, String titleTxt) throws Exception {
        SealConfiguration sealConfig = new SealConfiguration();
         ...
         * 边线粗细、半径
         */
        sealConfig.setBorderCircle(new SealCircle(2, 140, 100));
     ...
     * @throws Exception 异常
     */
    public static ByteArrayOutputStream genPersonSeal(int imageSize, int lineSize, SealFont font, String addString) throws Exception {
        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
        ImageIO.write(buildPersonSeal(imageSize, lineSize, font, addString), "png", outStream);
        return outStream;
    }
