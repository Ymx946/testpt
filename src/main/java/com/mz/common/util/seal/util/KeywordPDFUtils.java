...
public class KeywordPDFUtils {
    private static final Map<Integer, List<KeyWordBean>> map = new HashMap<Integer, List<KeyWordBean>>();
    // 定义返回页码
    ...
    public static void main(String[] args) {
        Map<Integer, List<KeyWordBean>> keyWords = getPDFText("D:\\Idea\\perfect_demo\\src\\main\\resources\\pdf\\src.pdf");
