...
public class PdfKeywordFinder {
    public static void main(String[] args) throws IOException {
        File pdfFile = new File("F:/eclipse-workspace-mangzhong/futurerural-all/futurerural-run-server/src/main/resources/pdf/程序员小王.pdf");
    ...
    private static class PdfRenderListener implements RenderListener {
        ...
        public void renderText(TextRenderInfo renderInfo) {
            ...
            for (TextRenderInfo textRenderInfo : characterRenderInfos) {
                ...
                float xPercent = Math.round(x * 10000) / 10000;
                float yPercent = Math.round(y * 10000) / 10000;
