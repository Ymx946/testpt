...
public class LunarUtil {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        today.setTime(DateUtil.parseDate(DateUtil.now()));
        LunarUtil lunar = new LunarUtil(today);
        System.out.println("北京时间：" + today.getTime()
                + "　农历" + lunar + "　月份" + lunar.month);
    }

    public static int getLunarMonth(String dateStr) {
        Calendar today = Calendar.getInstance();
        today.setTime(DateUtil.parseDate(dateStr));
        LunarUtil lunar = new LunarUtil(today);
        System.out.println("北京时间：" + today.getTime()
                + "　农历" + lunar + "　月份" + lunar.month);
        return lunar.month;
